...
# -------------------------------------------------
def test_off_oxford_comma():
    """more than two items"""

    arg = '"potato chips" coleslaw cupcakes "French silk pie"'
    out = getoutput(f'{prg} {arg} --off')
    expected = ('You are bringing potato chips, coleslaw, '
                'cupcakes and French silk pie.')
    assert out.strip() == expected
...
def test_separator():
    ...
    arg = '"potato chips" coleslaw cupcakes "French silk pie"'
    out = getoutput(f'{prg} {arg} --parser ;')
    expected = ('You are bringing potato chips; coleslaw; '
                'cupcakes; and French silk pie.')
    assert out.strip() == expected
...
#-------------------------------------------------
def test_separator_off_oxford_comma():
    """more than two items"""

    arg = '"potato chips" coleslaw cupcakes "French silk pie"'
    out = getoutput(f'{prg} {arg} --off --parser ;')
    expected = ('You are bringing potato chips; coleslaw; '
                'cupcakes and French silk pie.')
    assert out.strip() == expected
